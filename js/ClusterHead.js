...
class ClusterHead{
  constructor(uav){
    ...
    //branches is an empty array. What does it hold?
    this.branches = [];
    uav.shouldAcceptChildren = true;
    uav.ownWeight = 0;
    //First step of Mikes algorithm is to remove all children. This is what is happening here.
  ...
  draw(){
    ...
    for(let i=0; i<this.branches.length; ++i){
      ...
      //While head and child are truthy.
      while(head && child){
        push();
